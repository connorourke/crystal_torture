...
class PymatgenDopingTestCase(unittest.TestCase):
    ...
    def test_count_sites(self):
        ...
        self.assertEqual(
            count_sites(structure, labels={"A", "B", "O"}, species={"Mg", "Al", "O"}),
            56,
        )
    ...
    def test_doping(self, value):
        ...
        for conc in [0.5]:
            ...
            doped_conc = count_sites(
                structure_temp, species={"Li", "Al"}, labels={"A"}
            ) / count_sites(structure_temp, labels={"A"})
    ...
    def test_doping_by_no(self, value):
        ...
        for no_dopants in [10, 20, 30, 40]:
            ...
            structure_temp.make_supercell([value, value, value])
            dope_structure_by_no(
                structure_temp, no_dopants, "Mg", ["Li", "Al"], label_to_remove="A"
            )
